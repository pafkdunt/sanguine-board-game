...
/**
 * Mocked model where the first move possible wins a row so that move is made.
 */
public class FirstMoveWinsRowModel implements SanguineModel {
   ...
   */
  public FirstMoveWinsRowModel(Appendable log) throws IllegalArgumentException {
    if (log == null) {
