...
/**
 * Mocked model where an arbitrary move is valid and made.
 */
public class ArbitraryValidMoveModel implements SanguineModel {
   ...
   */
  public ArbitraryValidMoveModel(Appendable log) throws IllegalArgumentException {
    if (log == null) {
